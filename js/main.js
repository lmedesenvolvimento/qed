...
var uabGetAudio = {
  template: ' \
    <a md-button ng-show="$root.$mdMedia(\'gt-sm\')" target="blank" href="{{$ctrl.href}}?download=true"> \
      Baixar Audio \
    </a>\
    <a md-button class="md-icon-button" ng-if="$root.$mdMedia(\'xs\')" target="blank" href="{{$ctrl.href}}&download=true""> \
